...
export default function ProductCard({ product }) {
  return (
    <div className="flex flex-col bg-[#FAFAFA] p-0 group relative w-full">
      
      {/* container da imagem com fundo padrao do app */}
      ...
      <div className="flex flex-col pt-3 gap-1">
        ...
        <button className="mt-2 h-[40px] md:h-[48px] w-full bg-[#CDF22B] text-[#FAFAFA] font-bold text-[14px] md:text-[16px] uppercase cursor-pointer lg:opacity-0 lg:group-hover:opacity-100 transition-opacity duration-300">
          Comprar
        </button>
      </div>
    </div>
