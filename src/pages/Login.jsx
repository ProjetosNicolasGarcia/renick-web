      ...
      <div className="w-full max-w-[480px]">
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-4 w-full">
          ...
          <div className="flex justify-end mt-[-8px]">
            <Link to="/forgot-password" className="cursor-pointer text-sm md:text-base text-[#0A0A0A]/25 font-bold hover:text-[#0A0A0A]/60 uppercase transition-colors">
              Esqueci minha senha
            </Link>
          </div>
          ...
          <div className="flex justify-end mt-2">
            <Link to="/register" className="cursor-pointer text-sm md:text-base text-[#0A0A0A]/25 font-bold hover:text-[#0A0A0A]/60 uppercase transition-colors">
